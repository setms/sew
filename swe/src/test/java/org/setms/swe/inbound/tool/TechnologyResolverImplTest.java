...
class TechnologyResolverImplTest {
  ...
  @Test
  void shouldNeedTopLevelPackageAfterProgrammingLanguage() {
    var diagnostics = new ArrayList<Diagnostic>();
    var location = new Location("foo/bar");
    var decisions = List.of(decision(ProgrammingLanguage.TOPIC, "Java"));

    resolver.unitTestGenerator(decisions, location, diagnostics);
  ...
  @Test
  void shouldReturnGeneratorWhenBothDecisionsPresent() {
    var diagnostics = new ArrayList<Diagnostic>();
    var location = new Location("foo/bar");
    var decisions =
        List.of(
    ...
    var actual = resolver.unitTestGenerator(decisions, location, diagnostics);
