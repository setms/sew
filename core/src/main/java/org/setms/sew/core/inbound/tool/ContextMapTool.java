...
public class ContextMapTool extends Tool {
  ...
  private void build(ContextMap contextMap, OutputSink sink, Collection<Diagnostic> diagnostics) {
    var report = sink.select(contextMap.getName() + ".html");
  ...
  private mxGraph toGraph(ContextMap contextMap) {
    ...
    try {
      buildGraph(contextMap, edgeLabelPositions, result);
  ...
  private void buildGraph(
      ContextMap contextMap, Map<mxCell, EdgeLabelPlacement> edgeLabelPositions, mxGraph graph) {
